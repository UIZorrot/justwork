...
const MESSAGES = {
  en: {
    ...
    "gate.setup.loginWorkspace": "Log in to an existing workspace",
    ...
    "gate.unlock.title": "Log in to an existing workspace",
    "gate.unlock.description": "Enter the workspace ID and password to open an existing encrypted workspace.",
    "gate.unlock.workspaceIdPlaceholder": "Workspace ID",
    "gate.unlock.passwordPlaceholder": "Workspace password",
    "gate.unlock.button": "Log in and unlock",
    ...
    "editor.draftRecovery.description": "An unsynced local draft conflicts with the current document. Your draft is preserved; download it to recover your changes.",
    "editor.draftRecovery.download": "Download local draft",
    "editor.loadGuard.kicker": "Document unavailable",
    "editor.loadGuard.title": "This document did not load correctly",
    "editor.loadGuard.description": "Refresh the page before editing. Forcing edits against cached or incomplete content may create inconsistent versions or overwrite newer changes.",
    "editor.loadGuard.refresh": "Refresh page",
    "editor.loadGuard.forceEdit": "Force edit",
    "editor.loadGuard.forcedStatus": "Forced editing enabled · content may be inconsistent",
    ...
    "drawer.history.localHint": "Workspace history. Select a record to inspect its details.",
    "drawer.history.openDetail": "View details for {{event}}",
    "drawer.history.detail.kicker": "History detail",
    "drawer.history.detail.operation": "Operation",
    "drawer.history.detail.time": "Time",
    "drawer.history.detail.actor": "Actor",
    "drawer.history.detail.target": "Target",
    "drawer.history.detail.eventId": "Event ID",
    "drawer.history.detail.mutationId": "Mutation ID",
    "drawer.history.detail.changes": "Actual changes",
    "drawer.history.detail.added": "Added",
    "drawer.history.detail.removed": "Removed",
    "drawer.history.detail.noChanges": "No content change recorded",
    "drawer.history.detail.technical": "Technical snapshots",
    "drawer.history.detail.before": "Before",
    "drawer.history.detail.after": "After",
    "drawer.history.detail.empty": "No recorded value",
    "drawer.history.detail.unknownActor": "Unknown",
    ...
    "history.workspaceSettings": "Workspace settings",
    "history.memberProfile": "Member profile",
    "history.memberJoined": "Member joined",
    "drawer.profile.title": "Settings",
  ...
  "zh-CN": {
    ...
    "gate.setup.loginWorkspace": "登录已有工作区",
    ...
    "gate.unlock.title": "登录已有工作区",
    "gate.unlock.description": "输入工作区 ID 和密码，打开已有的加密工作区。",
    "gate.unlock.workspaceIdPlaceholder": "工作区 ID",
    "gate.unlock.passwordPlaceholder": "工作区密码",
    "gate.unlock.button": "登录并解锁",
    ...
    "editor.draftRecovery.description": "有一份未同步的本地草稿与当前文档冲突，草稿已保留。请下载草稿，找回其中的修改。",
    "editor.draftRecovery.download": "下载本地草稿",
    "editor.loadGuard.kicker": "文档不可用",
    "editor.loadGuard.title": "文档未能正确加载",
    "editor.loadGuard.description": "建议刷新页面后再编辑。强制编辑缓存或未完整加载的内容，可能造成版本不一致或覆盖较新的修改。",
    "editor.loadGuard.refresh": "刷新页面",
    "editor.loadGuard.forceEdit": "强制编辑",
    "editor.loadGuard.forcedStatus": "已启用强制编辑 · 内容可能不一致",
    "editor.folderPrefix": "[文件夹] ",
    "doc.root": "根目录",
    "drawer.history.title": "历史",
    "drawer.history.refresh": "刷新",
    "drawer.history.ariaLabel": "操作历史",
    "drawer.history.itemLabel": "文档",
    "drawer.history.eventLabel": "事件",
    "drawer.history.localHint": "工作区历史。点击记录可查看完整详情。",
    "drawer.history.openDetail": "查看“{{event}}”的详情",
    "drawer.history.detail.kicker": "历史详情",
    "drawer.history.detail.operation": "操作",
    "drawer.history.detail.time": "时间",
    "drawer.history.detail.actor": "操作者",
    "drawer.history.detail.target": "操作对象",
    "drawer.history.detail.eventId": "事件 ID",
    "drawer.history.detail.mutationId": "变更 ID",
    "drawer.history.detail.changes": "实际改动",
    "drawer.history.detail.added": "新增",
    "drawer.history.detail.removed": "删除",
    "drawer.history.detail.noChanges": "未记录到内容变化",
    "drawer.history.detail.technical": "技术快照（高级）",
    "drawer.history.detail.before": "变更前",
    "drawer.history.detail.after": "变更后",
    "drawer.history.detail.empty": "无记录值",
    "drawer.history.detail.unknownActor": "未知",
    "history.modify": "修改文档",
    "history.create": "新建条目",
    "history.move": "移动条目",
    "history.pin": "置顶变更",
    ...
    "history.workspaceSettings": "工作区设置",
    "history.memberProfile": "成员资料",
    "history.memberJoined": "成员加入",
    "drawer.profile.title": "设置",
