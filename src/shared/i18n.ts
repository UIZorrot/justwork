...
const MESSAGES = {
  en: {
    ...
    "gate.plan.paidDesc": "4× JustWork storage · 1000 history records · unlimited paid workspaces · custom PostgreSQL optional",
  ...
  "zh-CN": {
    ...
    "gate.plan.paidDesc": "使用 JustWork 存储时为 4 倍容量 · 保留 1000 条历史 · 付费工作区数量不限 · 独立 PostgreSQL 可选且不限额",
