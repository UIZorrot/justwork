...
const MESSAGES = {
  en: {
    ...
    "gate.plan.paidDesc": "4× storage · 1000 history records · unlimited paid workspaces · custom PostgreSQL optional",
  ...
  "zh-CN": {
    ...
    "gate.plan.paidDesc": "4 倍存储空间 · 保留 1000 条历史 · 付费工作区数量不限 · 独立 PostgreSQL 可选",
